...
class StegTab3(wx.Panel):
    ...
    def __init__(self,parent):
        ...
        """
        staticTitle = wx.StaticText(self,id=wx.ID_ANY,label=u"使用LSB-PM1的方式进行信息隐藏")
        ...
        Publisher.subscribe(self.updateGauge,"updateGauge_pm1")
    ...
    def OnStart(self,event):
        ...
        worker = LSB_PM1_Thread.LSB_PM1_Thread(src,dst,self.tofile)
        worker.start()
        pass
    ...
    def OnDecry(self,event):
        ...
        # else:
        #     pass
        worker = LSB_PM1_Thread.DeLSB_Thread(src,dst)
        worker.start()
